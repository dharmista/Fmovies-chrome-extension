...
(function() {
    ...
    document.body.innerHTML += "<div class='loader' style='display: none;position: fixed;z-index: 10000;top: 0;right: 0;bottom: 0;left: 0;'> <div class='blank' style='opacity: 0.8;top: 0;right: 0;bottom: 0;left: 0;background-color: black;position: absolute;z-index: -1;'></div> <p id='noOneWillNameInThisManner' class='loader-text' style='font-family: helvetica;font-size: 32px;color: white;margin-top: 200px;z-index: 10000;text-align: center;'>Generating...</p><p style='font-family: helvetica;font-size: 32px;color: white;margin-top: 200px;z-index: 10000;text-align: center;'>This might take a while. You can leave this at background.</p> </div>";

    function processFilesInUrls(forIdm) {
        if(forIdm)
            $(".loader").show();
        ...
        for(let index = 0; index < ranges; index+=1) {
            for (i = 0; i < episodes.length; i++) {
                if(episodes[i + index * episodes.length] != undefined) {
                    ...
                    filesLinkGetter(videoId, forIdm, countOfIndex);
                    countOfIndex += 1;
                }
            }
        }
    ...
    function createTxtFile() {
        ...
        domHyper.download = document.title.substring(document.title.indexOf(" ")+1, document.title.indexOf("|") -1)+".txt";
